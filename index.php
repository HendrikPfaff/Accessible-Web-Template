                            ...
                            <li>
                                <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <path fill="none"
                                              d="M10,0.469c-5.264,0-9.531,4.268-9.531,9.531c0,5.265,4.268,9.531,9.531,9.531c5.265,0,9.531-4.267,9.531-9.531C19.531,4.736,15.265,0.469,10,0.469 M10,18.665c-4.786,0-8.665-3.88-8.665-8.665c0-4.786,3.879-8.665,8.665-8.665V18.665z"></path>
                                    </svg>
                ...
                <div id="lab-wcag" class="lab-container">
                    <div class="icon-scp-top-left">
                        <div class="">
                            ...
                            +49-555-12345 | <a href="mailto:" aria-label="Email an info@bfree-toolkit.de senden"
                                               tabindex="0">info@bfree-toolkit.de</a>
                        </div>
                    </div>

                    <div class="ml-auto icon-scp-top">
                        <a aria-label="Facebook" tabindex="0">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                        ...
                        </a><a aria-label="Twitter" tabindex="0">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                        ...
                        </a><a aria-label="LinkedIn" tabindex="0">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                        ...
                        </a><a aria-label="Pinterest" tabindex="0">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
...
<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/B_free_logo.svg"
    ...
    <div class="jumbotron" id="jumbotron">
        ...
        <a class="wm-button button" href="#" role="button">Learn more</a>
        <jdoc:include type="module" name="jumbotron" />
    </div>
            ...
            <div class="inside-container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="team-item">
                            <figure tabindex="0">
                                <img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/member-2.jpg"
                                     alt="Member 2">
                                <figcaption>
                                    <div class="info">
                                        <h3>Ben. H</h3>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="team-item">
                            <figure tabindex="0">
                                <img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/member-3.jpg"
                                     alt="Member 3">
                                <figcaption>
                                    <div class="info">
                                        <h3>Catherine. G</h3>
