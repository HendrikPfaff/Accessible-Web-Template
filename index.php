                ...
                <div id="lab-wcag" class="lab-container">
                    <div class="icon-scp-top-left">
                        <div class="">
                            ...
                            +49-555-12345 | <a href="mailto:" aria-label="Email an info@bfree-toolkit.de senden" tabindex="0">info@bfree-toolkit.de</a>
                        </div>
                    </div>

                    <div class="ml-auto icon-scp-top">
                        <a aria-label="Seite auf Deutsch" tabindex="0">
                            DE
                        </a>
                        |
                        <a aria-label="Site in english" tabindex="0">
                            EN
                        </a>
                                ...
                                <div class="row">
                                    <div class="lab-offcanvas-menu lab-widget first last">
                                        <ul id="menu-main-menu-1" class="nav-menu">
                                            <li class="menu-item current-menu-item">
                                                <a class="" tabindex="-1">Home</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="" href="#about" tabindex="-1">About</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="" href="#features" tabindex="-1">Features</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="" href="#portfolios" tabindex="-1">Portfolio</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="" href="#team" tabindex="-1">Team</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="" href="#news" tabindex="-1">News</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="" href="#contact" tabindex="-1">Contact</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row footer-dark">
                    <div class="col-md-6  col-sm-6 col-12 copyright-text">
                        <p> ©
                            ...
                            2020 <a href="" target="_blank" rel="noopener">Someone</a>. All
                            Rights Reserved.
                        </p>
                    </div>
                    <div class="col-md-6  col-sm-6 col-12 copyright-text">
